	...
	buildTimeline() {
		...
		this.timeline.forEach((period) => {
			...
			if(this.options.opener.enabled) {
				...
				timelinePeriodOpennerWrapper.dataset.animationIn = this.options.opener.date.animationIn;
				timelinePeriodOpennerWrapper.dataset.animationInDuration = this.options.opener.date.animationInDuration;
				timelinePeriodOpennerWrapper.dataset.animationOut = this.options.opener.date.animationOut;
				timelinePeriodOpennerWrapper.dataset.animationOutDuration = this.options.opener.date.animationOutDuration;
...
new eTimeline({
	...
	options: {
		...
		opener: {
			...
			date: {
				animationInDuration: '1s',
				animationIn: 'zoom-out-letter-paralax-random',
				animationOut: 'slide-up-letters',
				animationOutDuration: 'zoom-out',
			}
		}
	}
